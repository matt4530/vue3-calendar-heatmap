...
import { Locale, TooltipFormatter, Value } from '../components/Heatmap';
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    heatmap: import("vue").Ref<{
        ...
        readonly yearsToHaveInlabels: number[];
    ...
    getSlicePosition: (index: number) => string;
    getItemPosition: (index: number) => string;
    getYearLabelPosition: (yearIndex: number) => {
        x: number;
        y: number;
    };
